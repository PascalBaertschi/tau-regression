...
def runLoop(index, fileList):

    logging.debug("Running loop No. %i" % index)
    #hadronic decays
    mytrainregfilehad = open('train_reg_ditau_mass_had_fullStat_%i.csv' % index,'wb')
    mytestregfilehad = open('test_reg_ditau_mass_had_fullStat_%i.csv' % index,'wb')
    myregfilehad = open('reg_ditau_mass_had_fullStat_%i.csv' % index,'wb')
    ...
    mytrainregfileinclnuhad = open('train_reg_ditau_mass_inclnu_had_fullStat_%i.csv' % index,'wb')
    mytestregfileinclnuhad = open('test_reg_ditau_mass_inclnu_had_fullStat_%i.csv' % index,'wb')
    myregfileinclnuhad = open('reg_ditau_mass_inclnu_had_fullStat_%i.csv' % index,'wb')
    ...
    mytrainregfiletotalhad = open('train_reg_ditau_mass_total_had_fullStat_%i.csv' % index,'wb')
    mytestregfiletotalhad = open('test_reg_ditau_mass_total_had_fullStat_%i.csv' % index,'wb')
    myregfiletotalhad = open('reg_ditau_mass_total_had_fullStat_%i.csv' % index,'wb')
    ...
    mytrainregfilevishad = open('train_reg_ditau_vismass_had_fullStat_new_%i.csv' % index,'wb')
    mytestregfilevishad = open('test_reg_ditau_vismass_had_fullStat_new_%i.csv' % index,'wb')
    myregfilevishad = open('reg_ditau_vismass_had_fullStat_new_%i.csv' % index,'wb')
    ...
    #all decays
    mytrainregfileall = open('train_reg_ditau_mass_all_fullStat_%i.csv' % index,'wb')
    mytestregfileall = open('test_reg_ditau_mass_all_fullStat_%i.csv' % index,'wb')
    myregfileall = open('reg_ditau_mass_all_fullStat_%i.csv' % index,'wb')
    ...
    mytrainregfileinclnu = open('train_reg_ditau_mass_inclnu_fullStat_%i.csv' % index,'wb')
    mytestregfileinclnu = open('test_reg_ditau_mass_inclnu_fullStat_%i.csv' % index,'wb')
    myregfileinclnu = open('reg_ditau_mass_inclnu_fullStat_%i.csv' % index,'wb')
    ...
    mytrainregfiletotal = open('train_reg_ditau_mass_total_fullStat_%i.csv' % index,'wb')
    mytestregfiletotal = open('test_reg_ditau_mass_total_fullStat_%i.csv' % index,'wb')
    myregfiletotal = open('reg_ditau_mass_total_fullStat_%i.csv' % index,'wb')
    ...
    mytrainregfiletheta = open('train_reg_ditau_theta_fullStat_%i.csv' % index,'wb')
    mytestregfiletheta = open('test_reg_ditau_theta_fullStat_%i.csv' % index,'wb')
    myregfiletheta = open('reg_ditau_theta_fullStat_%i.csv' % index,'wb')
    ...
    mytrainregfilevisall = open('train_reg_ditau_vismass_all_fullStat_%i.csv' % index,'wb')
    mytestregfilevisall = open('test_reg_ditau_vismass_all_fullStat_%i.csv' % index,'wb')
    myregfilevisall = open('reg_ditau_vismass_all_fullStat_%i.csv' % index,'wb')
...
def main():
    ...
    splitList = np.array_split(np.array(fileList), nProcesses)
    logging.debug(len(splitList))
    logging.debug(splitList)

    jobs = []
    for i in range(len(splitList)):
        p = multiprocessing.Process(target=runLoop, args=(i, splitList[i]))
        jobs.append(p)
        p.start()
